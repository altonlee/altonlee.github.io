...
You can view the finished application <a href="http://owo.meteorapp.com">here!</a>
...
Our final project consists of members Alton Lee, Emily Pang, and Jake Weber. Our project is inspired by the original HACC team (with the same name). 
...
Users can either log in or register as a new user. As a logged in user, they have access to the currently open audit registration and input. Even if they're not logged in, any user can view the published data and learn more about trash and its impacts on campus and environment. 
...
<ul>
  ...
  <li>Audit information can be edited after the event was created</li>
  <li>Charts and Graphs reflect all collected data per audit</li>
</ul>

Nearly all features were implemented. Had we more time, we would've been able to squash all bugs and cleaned up some parts of the app. I'm still proud of the work that we accomplished with this app, and I am happy to have had the opportunity to work on this. 
